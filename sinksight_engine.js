/* @ts-self-types="./sinksight_engine.d.ts" */
...
export class Engine {
    ...
    analyze(source) {
        ...
        const ret = wasm.engine_analyze(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * `libraryDb` is the raw `.slhdb` bytes. Pass `undefined` to analyze without a library database.
     * @param {Uint8Array | null} [library_db]
     */
    constructor(library_db) {
        var ptr0 = isLikeNone(library_db) ? 0 : passArray8ToWasm0(library_db, wasm.__wbindgen_malloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./sinksight_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sinksight_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
